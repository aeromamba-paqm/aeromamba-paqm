...
def run(args):
    ...
    if args.experiment.power_threshold > 0:
        ...
        print("Filtering Training items...") # Added print statement
        filtered_lr_set = []
        filtered_hr_set = []
    ...
    if args.dset.valid:
        ...
        if args.experiment.power_threshold > 0:
            # Filter items based on the threshold
            print("Filtering Validation items...") # Added print statement
            cv_filtered_lr_set = []
            cv_filtered_hr_set = []
            ...
            cv_dataset.lr_set = cv_filtered_lr_set
            cv_dataset.hr_set = cv_filtered_hr_set
