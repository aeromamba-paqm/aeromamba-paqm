...
def write(wav, filename, sr):
    ...
    #wav = convert_float_to_int16(wav)
...
def run_matlab_process_files(folder_path, epoch_number):
    matlab_command = f"matlab -r \"process_files('{folder_path}', {epoch_number}); exit;\""
